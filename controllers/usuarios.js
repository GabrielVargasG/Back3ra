...
const registarNiveles = async(req, res = response) => {
    ...
    const docs = [
        ...
        {  nombre: "Nivel 2", completo: "false", usuario:req.usuario._id, valor: 0, grado: "2",action:"Nivel2_2"},
        {  nombre: "Nivel 3", completo: "false", usuario:req.usuario._id, valor: 0, grado: "2",action:"Nivel3_2"},
        {  nombre: "Nivel 4", completo: "false", usuario:req.usuario._id, valor: 0, grado: "2",action:"Nivel4_2"},
        {  nombre: "Nivel 5", completo: "false", usuario:req.usuario._id, valor: 0, grado: "2",action:"Nivel5_2"},
        {  nombre: "Nivel 6", completo: "false", usuario:req.usuario._id, valor: 0, grado: "2",action:"Nivel6_2"},
        {  nombre: "Nivel 7", completo: "false", usuario:req.usuario._id, valor: 0, grado: "2",action:"Nivel7_2"},
        {  nombre: "Nivel 8", completo: "false", usuario:req.usuario._id, valor: 0, grado: "2",action:"Nivel8_2"},
        {  nombre: "Nivel 9", completo: "false", usuario:req.usuario._id, valor: 0, grado: "2",action:"Nivel9_2"},
        {  nombre: "Nivel 10", completo: "false", usuario:req.usuario._id, valor: 0, grado: "2",action:"Nivel10_2"},
        {  nombre: "Nivel 11", completo: "false", usuario:req.usuario._id, valor: 0, grado: "2",action:"Nivel11_2"},
        {  nombre: "Nivel 12", completo: "false", usuario:req.usuario._id, valor: 0, grado: "2",action:"Nivel12_2"},
